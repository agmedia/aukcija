...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./Users/alive/Sites/Agmedia/Live/aukcija/public/storage' => 'string',
            ...
            'settings.order.canceled_status' => 'string',
...
'filesystems.disks.widget.url','filesystems.disks.qr.driver','filesystems.disks.qr.root','filesystems.disks.qr.url','filesystems.links./Users/alive/Sites/Agmedia/Live/aukcija/public/storage',
...
'mail.markdown.theme','mail.markdown.paths','pulse.domain','pulse.path','pulse.enabled',
...
'session.http_only','session.same_site','session.partitioned','settings.free_shipping','settings.pagination.front',
'settings.pagination.back','settings.search_keyword','settings.author_path','settings.publisher_path','settings.group_path',
'settings.unknown_author','settings.unknown_publisher','settings.images_domain','settings.default_tax_id','settings.eur_divide_amount',
'settings.sorting_list.0.title','settings.sorting_list.0.value','settings.sorting_list.1.title','settings.sorting_list.1.value','settings.sorting_list.2.title',
'settings.sorting_list.2.value','settings.sorting_list.3.title','settings.sorting_list.3.value','settings.sorting_list.4.title','settings.sorting_list.4.value',
'settings.actions_sorting_list.0.title','settings.actions_sorting_list.0.type','settings.actions_sorting_list.0.value','settings.actions_sorting_list.1.title','settings.actions_sorting_list.1.type',
'settings.actions_sorting_list.1.value','settings.actions_sorting_list.2.title','settings.actions_sorting_list.2.type','settings.actions_sorting_list.2.value','settings.actions_sorting_list.3.title',
'settings.actions_sorting_list.3.type','settings.actions_sorting_list.3.value','settings.actions_sorting_list.4.title','settings.actions_sorting_list.4.type','settings.actions_sorting_list.4.value',
'settings.actions_sorting_list.5.title','settings.actions_sorting_list.5.type','settings.actions_sorting_list.5.value','settings.actions_sorting_list.6.title','settings.actions_sorting_list.6.type',
'settings.actions_sorting_list.6.value','settings.actions_sorting_list.7.title','settings.actions_sorting_list.7.type','settings.actions_sorting_list.7.value','settings.order.made_text',
'settings.order.status.new','settings.order.status.unfinished','settings.order.status.declined','settings.order.status.canceled','settings.order.status.paid',
'settings.order.status.send','settings.order.status.ready','settings.order.new_status','settings.order.canceled_status','settings.special_action.title',
'settings.special_action.start','settings.special_action.end','settings.payment.providers.corvus','settings.payment.providers.cod','settings.payment.providers.bank',
'settings.payment.providers.pickup','settings.sitemap','settings.njuskalo.user_id','settings.njuskalo.sync.fantasy','settings.njuskalo.sync.djecje-knjige',
'settings.njuskalo.sync.beletristika','settings.njuskalo.sync.proza','settings.njuskalo.sync.sf','settings.njuskalo.sync.knjizevnost','settings.njuskalo.sync.outlet',
'settings.njuskalo.sync.duhovne-knjige','settings.njuskalo.sync.povijest','settings.njuskalo.sync.autobiografije-i-biografije','settings.njuskalo.sync.kompleti','settings.njuskalo.sync.alternativne-knjige',
'settings.njuskalo.sync.savjetnici','settings.njuskalo.sync.psihologija','settings.njuskalo.sync.rijetke-knjige','settings.njuskalo.sync.erotske-knjige','settings.njuskalo.sync.nakladnici',
'settings.njuskalo.sync.knjige-na-stranom-jeziku','settings.njuskalo.sync.religija-i-mitologija','settings.njuskalo.sync.antikvarne-knjige','settings.njuskalo.sync.militarija','settings.njuskalo.sync.kuharice',
'settings.njuskalo.sync.publicistika','settings.njuskalo.sync.ostala-literatura','settings.njuskalo.sync.strucna-literatura','settings.njuskalo.sync.enciklopedije-i-leksikon','settings.njuskalo.sync.monografije',
'settings.njuskalo.sync.putopisi','settings.njuskalo.sync.rjecnici','settings.njuskalo.sync.filozofija','settings.njuskalo.sync.poezija','settings.njuskalo.sync.stripovi',
'settings.njuskalo.sync.wattpad-i-domaci-pisci','settings.njuskalo.sync.nekategorizirane','settings.njuskalo.sync.casopisi','settings.njuskalo.sync.bookmarkeri','settings.njuskalo.sync.fotografija',
'settings.njuskalo.sync.bojanke-za-odrasle','settings.njuskalo.sync.rokovnici','settings.njuskalo.sync.gift-program','settings.njuskalo.sync.karte','settings.njuskalo.sync.svezalice-pidzame-za-knjige',
'shopping_cart.format_numbers','shopping_cart.decimals','shopping_cart.dec_point','shopping_cart.thousands_sep','shopping_cart.storage',
'shopping_cart.events','telescope.enabled','telescope.domain','telescope.path','telescope.driver',
...
'debugbar.debug_backtrace_limit','blade-heroicons.prefix','blade-heroicons.fallback','blade-heroicons.class','blade-heroicons.attributes',
...
'livewire-tables.dateRange.defaultConfig.earliestDate','livewire-tables.dateRange.defaultConfig.latestDate','livewire-tables.dateRange.defaultConfig.locale','livewire-tables.numberRange.defaultOptions.min','livewire-tables.numberRange.defaultOptions.max',
'livewire-tables.numberRange.defaultConfig.minRange','livewire-tables.numberRange.defaultConfig.maxRange','livewire-tables.numberRange.defaultConfig.suffix','livewire-tables.numberRange.defaultConfig.prefix','livewire-tables.selectFilter.defaultOptions',
'livewire-tables.selectFilter.defaultConfig','livewire-tables.multiSelectFilter.defaultOptions','livewire-tables.multiSelectFilter.defaultConfig','livewire-tables.multiSelectDropdownFilter.defaultOptions','livewire-tables.multiSelectDropdownFilter.defaultConfig',
'livewire-tables.events.enableUserForEvent','ide-helper.filename','ide-helper.models_filename','ide-helper.meta_filename','ide-helper.include_fluent',
...
'TELESCOPE_ENABLED','PHP_CLI_SERVER_WORKERS','BCRYPT_ROUNDS','LOG_CHANNEL','LOG_STACK',
