    ...
    <div class="bg-body-light">
        <div class="content content-full">
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                <h1 class="flex-sm-fill font-size-h2 font-w400 mt-2 mb-0 mb-sm-2">Atributi </h1>
                <a class="btn btn-hero-success my-2" href="{{ route('attributes.create') }}">
                    <i class="far fa-fw fa-plus-square"></i><span class="d-none d-sm-inline ml-1">Dodaj novi atribut</span>
                </a>
            </div>
        </div>
    </div>
    ...
    @include('back.layouts.partials.session')
        ...
        <div class="block">
            <div class="block-header block-header-default">
                <h3 class="block-title">Lista atributa ({{ $attributes->total() }})</h3>
            </div>
