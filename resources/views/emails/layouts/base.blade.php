    ...
    <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="600" style="margin: auto;" class="email-container">
        ...
        <tr>
            <td style="padding: 20px 0 15px 0; text-align: center">
                <label class="large bold" style="color: white;">   <img src="{{ asset('media/logo-aukcije4a-nobck.png') }}" alt="aukcija4a.com" border="0" style="max-width:300px;height: auto;"></label>
            </td>
        </tr>
        <!-- Email Header : END -->
