...
'auctions.store','auctions.edit','auctions.update','auctions.destroy','blogs',
'blogs.create','blogs.store','blogs.edit','blogs.update','blogs.destroy',
'users','users.create','users.store','users.edit','users.update',
'widgets','widget.create','widget.store','widget.edit','widget.update',
'widget.group.create','widget.group.store','widget.group.edit','widget.group.update','api.index',
'pages','pages.create','pages.store','pages.edit','pages.update',
'pages.destroy','faqs','faqs.create','faqs.store','faqs.edit',
'faqs.update','faqs.destroy','geozones','geozones.create','geozones.store',
'geozones.edit','geozones.update','geozones.destroy','order.statuses','shippings',
'payments','taxes','currencies','history','history.show',
'cache','maintenance.on','maintenance.off','api.front.search','auctions.autocomplete',
'auctions.destroy.image','auctions.change.status','auctions.update.item','auctions.destroy.action','products.destroy.api',
'actions.destroy.api','authors.destroy.api','publishers.destroy.api','blogs.destroy.api','blogs.upload.image',
'widget.destroy','widget.api.get-links','api.api.import','api.api.upload','api.auction.status.store',
'api.auction.status.destroy','api.auction.status.change','api.auction.send.gls','api.payment.store','api.payment.destroy',
'api.shipping.store','api.shipping.destroy','api.taxes.store','api.taxes.destroy','api.currencies.store',
'api.currencies.store.main','api.currencies.destroy','index','kontakt','poruka',
'faq','kosarica','naplata','pregled','checkout',
'checkout.success','checkout.error','pretrazi','catalog.route.page','catalog.route.blog','sitemap','sitemap',
'njuskalo','catalog.route.author','catalog.route.publisher','catalog.route.actions',
'catalog.route','storage.local',);
        registerArgumentsSet('views',
'api.api-token-manager','api.index','auth.confirm-password','auth.forgot-password','auth.login',
'auth.register','auth.reset-password','auth.two-factor-challenge','auth.verify-email','back.catalog.auction.edit',
'back.catalog.auction.edit-photos','back.catalog.auction.index','back.catalog.auction.org-edit-photos','back.catalog.category.edit','back.catalog.category.index',
'back.dashboard','back.layouts.app','back.layouts.backend','back.layouts.guest','back.layouts.partials.aside',
'back.layouts.partials.popover','back.layouts.partials.required-star','back.layouts.partials.session','back.layouts.partials.sidebar','back.layouts.partials.status',
'back.layouts.partials.topbar','back.layouts.simple','back.marketing.action.edit','back.marketing.action.index','back.marketing.blog.edit',
'back.marketing.blog.index','back.order.edit','back.order.index','back.order.show','back.settings.api.index',
'back.settings.app.currency','back.settings.app.geozone.edit','back.settings.app.geozone.index','back.settings.app.order_status','back.settings.app.payment.modals.bank',
'back.settings.app.payment.modals.cod','back.settings.app.payment.modals.corvus','back.settings.app.payment.modals.payway','back.settings.app.payment.modals.pickup','back.settings.app.payment.modals.wspay',
'back.settings.app.payment.payment','back.settings.app.shipping.modals.flat','back.settings.app.shipping.modals.gls','back.settings.app.shipping.modals.gls_eu','back.settings.app.shipping.modals.gls_world',
'back.settings.app.shipping.modals.pickup','back.settings.app.shipping.shipping','back.settings.app.tax','back.settings.faq.edit','back.settings.faq.index',
'back.settings.history.index','back.settings.history.show','back.settings.pages.edit','back.settings.pages.index','back.settings.settings',
'back.user.edit','back.user.index','back.widget.edit-group','back.widget.index','back.widget.templates.custom',
'back.widget.templates.page_carousel','back.widget.templates.product_carousel','back.widget.templates.simple_card','components.action-message','components.action-section',
'components.application-logo','components.application-mark','components.authentication-card','components.authentication-card-logo','components.banner',
...
'components.dialog-modal','components.dropdown','components.dropdown-link','components.form-section','components.input',
'components.input-error','components.label','components.modal','components.nav-link','components.responsive-nav-link',
'components.secondary-button','components.section-border','components.section-title','components.switchable-team','components.validation-errors',
'components.welcome','dashboard','emails.team-invitation','front.404','front.blog',
'front.catalog.authors.index','front.catalog.category.index','front.catalog.category.product','front.catalog.product.index','front.catalog.publishers.index',
'front.checkout.cart','front.checkout.checkout','front.checkout.error','front.checkout.payment.bank','front.checkout.payment.cod',
'front.checkout.payment.corvus','front.checkout.payment.payway','front.checkout.payment.pickup','front.checkout.payment.wspay','front.checkout.success',
'front.checkout.view','front.contact','front.customer.index','front.customer.layouts.header','front.customer.layouts.sidebar',
'front.customer.moje-narudzbe','front.faq','front.home','front.layouts.app','front.layouts.partials.footer',
'front.layouts.partials.handheld','front.layouts.partials.header','front.layouts.partials.hometemp','front.layouts.partials.njuskalo','front.layouts.partials.otkupwidget',
'front.layouts.partials.recaptcha-js','front.layouts.partials.search_result','front.layouts.partials.session','front.layouts.partials.sitemap','front.layouts.partials.sitemap-image',
'front.layouts.partials.sitemap-index','front.layouts.partials.steps','front.layouts.partials.success-session','front.layouts.widget.widget_custom','front.layouts.widget.widget_page_carousel',
'front.layouts.widget.widget_product_carousel','front.layouts.widget.widget_simple_card','front.page','layouts.app','layouts.guest',
'navigation-menu','policy','profile.delete-user-form','profile.logout-other-browser-sessions-form','profile.show',
'profile.two-factor-authentication-form','profile.update-password-form','profile.update-profile-information-form','pulse::dashboard','terms',
'vendor.pulse.dashboard','welcome','02a8dc4cf01fed584c6423f577c0b0d7::card','02a8dc4cf01fed584c6423f577c0b0d7::card-header','02a8dc4cf01fed584c6423f577c0b0d7::http-method-badge',
...
'02a8dc4cf01fed584c6423f577c0b0d7::thead','02a8dc4cf01fed584c6423f577c0b0d7::theme-switcher','02a8dc4cf01fed584c6423f577c0b0d7::user-card','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context',
...
'pulse::livewire.usage','telescope::layout',);
